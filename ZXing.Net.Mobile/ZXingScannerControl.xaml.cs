...
namespace ZXing.Mobile
{
    public sealed partial class ZXingScannerControl : UserControl, IScannerView, IScannerSessionHost, IDisposable
    {
        ...
        public async void StartScanning(Action<IScanResult> scanCallback, MobileBarcodeScanningOptions options = null)
        ...
        public async Task StartScanningAsync(Action<IScanResult> scanCallback, MobileBarcodeScanningOptions options = null)
        {
            if (stopping)
            {
            ...
            timerPreview = new Timer(async (state) =>
            {
                ...
                if (result != null && !string.IsNullOrEmpty(result.Text))
                {
                    ...
                    ScanCallback(new ScanResult(result, null));
                }
        ...
        public Action<IScanResult> ScanCallback { get; set; }
