...
namespace ZXing.MonoTouch.Sample
{
	public class CustomOverlayView : UIView
	{
		...
		public CustomOverlayView () : base()
		{
			...
			ButtonTorch.Frame = new RectangleF(this.Frame.Width / 2 + 5, this.Frame.Height - 40, this.Frame.Width / 2 - 10, 34);
			...
			ButtonCancel.Frame = new RectangleF(0, this.Frame.Height - 40, this.Frame.Width / 2 - 10, 34);
