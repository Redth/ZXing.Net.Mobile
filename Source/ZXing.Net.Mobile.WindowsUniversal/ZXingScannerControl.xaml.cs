...
namespace ZXing.Mobile
{
    public sealed partial class ZXingScannerControl : UserControl, IScannerView, IDisposable
    {
        ...
        public bool IsTorchOn => HasTorch && mediaCapture.VideoDeviceController.TorchControl.Enabled;

        public void Torch(bool on)
        {
            if (HasTorch) mediaCapture.VideoDeviceController.TorchControl.Enabled = on;
        }

        public void ToggleTorch()
        {
            if (HasTorch) Torch(!IsTorchOn);
        }
